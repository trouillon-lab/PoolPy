        ...
        ui.nav_panel("Prevalence",
                ...
                ui.div(
                    ui.row(
                        ...
                        ui.column(3,
                            ui.input_numeric("prev_max_error", "Max probability of misparametrization:", value=0.05),
                        ),
                    ),
                    style="margin-top: 30px;"
                ),
            ...
            ui.div(
                ui.div(
                    ...
                    ui.p(
                        ...
                        "Instead, PoolPy is designed to tailor combinatorial testing to each use case by balancing throughput, prevalence, robustness, and experimental limitations.",
                        style="margin-bottom: 16px;"
                    ),
                    ui.p(
                        "PoolPy supports both standard binary screening assays and more complex multi-readout profiling experiments. "
                        "Across applications including protein-ligand screening, RT-qPCR viral testing, and genome-wide protein-DNA interaction profiling, PoolPy reduced the number of required measurements by about 60% to 93% while preserving interpretable results.",
                        style="margin-bottom: 16px;"
                    ),
                    ui.p(
                    ...
                    ui.p(
                        "For inquiries and feedback, please contact: jtrouillon [at] ethz [dot] ch",
                    ),
                    style="""
                        text-align: center;
                        margin: 30px auto;
